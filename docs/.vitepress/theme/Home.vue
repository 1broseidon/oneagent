...
const features = [
  {
    ...
    description: 'Every backend returns the same JSON shape. Stream events, parse results, switch models — your code never changes.',
  },
  {
...
<template>
  <div class="home">
    ...
    <nav class="home-nav">
      <div class="nav-left">
        <a href="https://chain.sh" class="nav-back">CHAIN.SH</a>
        <span class="nav-sep">/</span>
        <span class="nav-title">ONEAGENT</span>
      </div>
      <a href="https://github.com/1broseidon/oneagent" target="_blank" rel="noopener" class="nav-icon">
    ...
    <!-- Hero -->
    <main class="hero fade-up" style="animation-delay: 100ms">
      <h1 class="headline">OA</h1>
      ...
      <!-- Actions -->
      <div class="actions">
        <a href="/oneagent/guide/getting-started" class="action-primary">Get Started</a>
        <a href="https://github.com/1broseidon/oneagent" target="_blank" rel="noopener" class="action-secondary">View Source</a>
      </div>
    </main>

    <!-- Features -->
    <section class="features fade-up" style="animation-delay: 200ms">
      <div class="section-header">
        <h2 class="section-title">Features</h2>
        <div class="section-divider"></div>
        <span class="section-count">{{ String(features.length).padStart(2, '0') }} Modules</span>
      </div>
      <div class="feature-grid">
        <div v-for="(feature, i) in features" :key="feature.title" class="feature-card">
          <span class="feature-index">{{ String(i + 1).padStart(3, '0') }}</span>
    ...
    <!-- Quick Start -->
    <section class="quickstart fade-up" style="animation-delay: 300ms">
      <div class="section-header">
...
oa -b codex --post-run 'notify-send "oa" "Done: $(head -c 100)"' "fix the bug"</code></pre>
    ...
    <!-- Footer -->
    <footer class="home-footer fade-up" style="animation-delay: 400ms">
      <div class="footer-line">
        <span>&copy; {{ new Date().getFullYear() }} CHAIN.SH / ONEAGENT</span>
        <a href="https://chain.sh" class="footer-back">&larr; CHAIN.SH</a>
      </div>
    </footer>
  </div>
</template>
...
.nav-back:hover { color: var(--vp-c-text-1); }

.nav-sep { color: var(--vp-c-text-3); }

.nav-title { color: var(--vp-c-text-1); }
...
.nav-icon:hover { color: var(--vp-c-text-1); }
